    ...
    <%@page import="com.sunilos.p4.ctl.LoginCtl" %>
        <%@page import="com.sunilos.p4.bean.UserBean" %>
            <%@page import="com.sunilos.p4.ctl.ORSView" %>
                <% MessageSource ms=MessageSource.getInstance(); String locale=ms.getLanguage(); UserBean
                    userBean=(UserBean) session.getAttribute("user"); boolean loggedIn=userBean !=null; boolean
                    isAdmin=loggedIn && userBean.getRoleId()==RoleBean.ADMIN; boolean isStudent=loggedIn &&
                    userBean.getRoleId()==RoleBean.STUDENT; String displayName=loggedIn ? userBean.getFirstName() + " ("
                    + session.getAttribute("role") + ")" : "Guest" ; %>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-dark py-0"
                        ...
                        <div class="container-fluid px-4">
                            ...
                            <a class="navbar-brand fw-bold d-flex align-items-center gap-2 py-2"
                                ...
                                <img src="<%=ORSView.APP_CONTEXT%>/img/customLogo.jpg" alt="ORS" height="34"
                                    ...
                                    <ul class="navbar-nav me-auto gap-0">
                                        ...
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle px-3 py-3" href="#"
                                                ...
                                                <i class="bi bi-file-earmark-text me-1"></i> Marksheet
                                            </a>
                                            <ul class="dropdown-menu dropdown-menu-dark shadow border-0 rounded-3"
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="<%=ORSView.GET_MARKSHEET_CTL%>">
                                                        <i class="bi bi-search me-2 text-info"></i> Get Marksheet
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="<%=ORSView.MARKSHEET_MERIT_LIST_CTL%>">
                                                        <i class="bi bi-trophy me-2 text-warning"></i> Merit List
                                                    </a>
                                                </li>
                                                <% if (isAdmin) { %>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="<%=ORSView.MARKSHEET_LIST_CTL%>">
                                                            <i class="bi bi-list-ul me-2 text-primary"></i> Marksheet
                                                            List
                                                        </a>
                                                    </li>
                                        ...
                                        <% if (isAdmin) { %>
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-dark shadow border-0 rounded-3"
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="<%=ORSView.COLLEGE_LIST_CTL%>">
                                                            <i class="bi bi-building me-2 text-primary"></i> College
                                                            List
                                                        </a>
                                                    </li>
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-dark shadow border-0 rounded-3"
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="<%=ORSView.STUDENT_CTL%>">
                                                            <i class="bi bi-person-plus me-2 text-success"></i> Add
                                                            Student
                                                        </a>
                                                    </li>
                                                    <li>
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-dark shadow border-0 rounded-3"
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="<%=ORSView.COLLEGE_REPORT_CTL%>"
                                                            target="_blank">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="<%=ORSView.COURSE_REPORT_CTL%>"
                                                            target="_blank">
                                                            <i class="bi bi-file-earmark-pdf me-2 text-warning"></i>
                                                            Course List
                                                        </a>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="<%=ORSView.SUBJECT_REPORT_CTL%>"
                                                            target="_blank">
                                                            <i class="bi bi-file-earmark-pdf me-2 text-warning"></i>
                                                            Subject List
                                                        </a>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="<%=ORSView.STUDENT_REPORT_CTL%>"
                                                            target="_blank">
                                                            <i class="bi bi-file-earmark-pdf me-2 text-warning"></i>
                                                            Student List
                                                        </a>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="<%=ORSView.FACULTY_REPORT_CTL%>"
                                                            target="_blank">
                                                            <i class="bi bi-file-earmark-pdf me-2 text-warning"></i>
                                                            Faculty List
                                                        </a>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="<%=ORSView.USER_REPORT_CTL%>"
                                                            target="_blank">
                                                            <i class="bi bi-file-earmark-pdf me-2 text-warning"></i>
                                                            User List
                                                        </a>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="<%=ORSView.ROLE_REPORT_CTL%>"
                                                            target="_blank">
                                                            <i class="bi bi-file-earmark-pdf me-2 text-warning"></i>
                                                            Role List
                                                        </a>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="<%=ORSView.MARKSHEET_REPORT_CTL%>" target="_blank">
                                                            <i class="bi bi-file-earmark-pdf me-2 text-warning"></i>
                                                            Marksheet List
                                                        </a>
                                                    </li>
                                                ...
                                                <li class="nav-item">
                                                    <form class="d-flex align-items-center m-0">
                                                        <select class="form-select form-select-sm border-0 py-1"
                                                            name="lang" id="lang" onchange="this.form.submit()" style="width:120px; background:rgba(255,255,255,0.12);
                           color:#fff; font-size:0.82rem; cursor:pointer;">
                                                ...
                                                <!-- Home -->
                                                <li class="nav-item">
                                                    <a class="nav-link px-2" href="<%=ORSView.WELCOME_CTL%>">
                                                ...
                                                <% if (loggedIn) { %>
                                                    <li class="nav-item dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end shadow border-0 rounded-3"
                                                            style="min-width:210px; background:#1a2e4a;">
                                                            <li>
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item"
                                                                    ...
                                                                    <i class="bi bi-key me-2 text-warning"></i> Change
                                                                    Password
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item"
                                                                    ...
                                                                    <i class="bi bi-book me-2 text-success"></i> Java
                                                                    Doc
                                                                </a>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <% } else { %>
                                                        <!-- Login button (guest) -->
                                                        <li class="nav-item">
                                                            <a class="btn btn-sm btn-outline-light ms-1 px-3"
